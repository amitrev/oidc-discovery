...
class Discovery
{
     ...
     */
    public function __construct(AbstractProvider $provider, string $wellKnownUrl)
    {
        ...
        $this->wellKnownConfiguration = json_decode((string)$httpResponse->getBody(), false, 512, JSON_THROW_ON_ERROR);
    ...
    protected function fetchPublicKeyFromServer(): array
    {
        ...
        return json_decode((string)$httpResponse->getBody()->getContents(), true, 512, JSON_THROW_ON_ERROR);
    }
