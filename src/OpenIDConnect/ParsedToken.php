...
class ParsedToken
{
    ...
    {
        if ($date_format && $this->exp) {
            return date($date_format, (int)$this->exp);
        }
    ...
    {
        if ($date_format && $this->nbf) {
            return date($date_format, (int)$this->nbf);
        }
    ...
    {
        if ($date_format && $this->iat) {
            return date($date_format, (int)$this->iat);
        }
    ...
    {
        return !$this->isExpired() && time() >= $this->getNotBefore();
    }
